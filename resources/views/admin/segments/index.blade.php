...
@section('pageBar')
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="javascript:;" class="kt-subheader__breadcrumbs-link">Segments </a>
        </div>
    </div>
@stop
                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <button href="#" class="btn btn-brand btn-elevate btn-icon-sm dataModel"
                                data-href="{{ route('admin.segments.create') }}"
                                data-title="Add new"
                            >
                                    ...
                                    <td>
                                        <span>
                                            <button
                                               ...
                                               title="Edit details"
                                               data-href="{{ route('admin.segments.edit', $model->id) }}"
                                               data-title="Edit"
                                            >
                                            ...
                                            <a
                                                href="{{ route('admin.segments.delete', $model->id) }}"
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $('.segments-menu').addClass('kt-menu__item--active');
        });
    </script>
@stop