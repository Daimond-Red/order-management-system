...
@section('pageBar')
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="javascript:;" class="kt-subheader__breadcrumbs-link">Cancel Bookings </a>
        </div>
    </div>
    ...
    <div class="col-xl-12">
        ...
        <div class="kt-portlet">
            ...
            <div class="kt-portlet__body">
                <div class="kt-section table-responsive">
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $('.booking-cancel-menu').addClass('kt-menu__item--active');
        });
    </script>
@stop