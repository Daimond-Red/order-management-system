...
@section('pageBar')
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="javascript:;" class="kt-subheader__breadcrumbs-link"> Type of Cargos </a>
        </div>
    </div>
@stop
                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <button href="#" class="btn btn-brand btn-elevate btn-icon-sm dataModel"
                                data-href="{{ route('admin.cargoTypes.create') }}"
                                data-title="Add new"
                            >
                                    ...
                                    <td>
                                        <span>
                                            <button
                                               ...
                                               title="Edit details"
                                               data-href="{{ route('admin.cargoTypes.edit', $model->id) }}"
                                               data-title="Edit"
                                            >
                                            ...
                                            <a
                                                href="{{ route('admin.cargoTypes.delete', $model->id) }}"
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $('.cargotype-menu').addClass('kt-menu__item--active');
        });
    </script>
@stop