...
@section('pageBar')
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="javascript:;" class="kt-subheader__breadcrumbs-link"> Create Order </a>
        </div>
    </div>
@stop
...
@section('script')
    <script>
        $(document).ready(function(){
            $('.orders-menu').addClass('kt-menu__item--open');
            $('.create-order-menu').addClass('kt-menu__item--active');
        });
    </script>
@stop