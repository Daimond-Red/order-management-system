...
@section('pageBar')
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="{{ route('admin.vehicles.index', ['vendor_id' => $vendor->id ]) }}" class="kt-subheader__breadcrumbs-link"> Vehicles </a>
...
@section('content')
    ...
    <div class="card shadow px-5 py-4">
        <div class="row">
            <img style="border-radius:50%;" src="{{ getImageUrl($model->image) }}" alt="" width="100" height="100">
            <div class="ml-5">
                <h2 class="kt-font-dark">{{ $model->name }}</h2>
                <h6 class="kt-label-font-color-3 ">{{ $model->email }}</h6>
                <div class="mt-4">
                    <a href="#" class="btn btn-sm btn-primary">Vehicle</a>
                    
                    @if(!$model->is_verified )
                        <a href="#" class="btn btn-sm btn-danger">Unverified</a>
                    @elseif($model->is_verified == 1) 
                        <a href="#" class="btn btn-sm btn-success">Verified</a>
                    @elseif($model->is_verified == 2)
                        <a href="#" class="btn btn-sm btn-success">Self Verified</a>
                    @endif
                </div>
            </div>
        </div>
                ...
                <div class="tab-content">
                                    ...
                                    <div class="col-12 col-sm-4 mt-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <div class="kt-notification__item-time">
                                                    <span class="kt-font-dark kt-font-bold">
                                                        City : {{ optional($model->startCityRel)->title ? optional($model->startCityRel)->title : 'NA'  }}<br>
                                                        From Date : {{ $model->date ? date('d F Y', strtotime($model->date)) : 'NA'  }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-4 mt-4">
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <div class="kt-notification__item-time">
                                                    <p class="kt-font-dark kt-font-bold">{{optional($model->vehicleTypeRel)->title}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane" id="kt_portlet_base_demo_1_2_tab_content" role="tabpanel">
                        <table class="table data-table table-bordered">
                            ...
                            <tbody>
                                <?php $collection = $model->bookingVehicleRel; ?>
                                @if(!count($collection))

                                @else 
                                    
                                    @foreach( $collection as $bookingModel )
                                    {{-- {{ dd($bookingModel->bookingRel) }} --}}
                                    <?php $bookingModel = $bookingModel->bookingRel;  ?>
                                    <tr>
