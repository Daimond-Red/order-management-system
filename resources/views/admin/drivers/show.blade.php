...
@section('pageBar')
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="{{ route('admin.drivers.index', ['vendor_id' => $vendor->id ]) }}" class="kt-subheader__breadcrumbs-link"> Drivers </a>

            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="javascript:;" class="kt-subheader__breadcrumbs-link"> Driver </a>
        </div>
    </div>
@stop
    ...
    <div class="card shadow px-5 py-4">
        <div class="row">
            ...
            <div class="ml-5">
                ...
                <div class="mt-4">
                    <a href="#" class="btn btn-sm btn-primary">Driver</a>
                    
                    @if(!$model->status)
                        <a href="#" class="btn btn-sm btn-warning">Document Pending</a>
                ...
                <div class="tab-content">
                                    ...
                                    <div class="col-12 col-sm-4 mt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                ...
                                                <div class="kt-notification__item-time">
                                                    <p class="kt-font-dark kt-font-bold">{{$model->address}}</p>
                                                    <p class="kt-font-dark kt-font-bold">{{optional($model->stateRel)->title}}, {{optional($model->cityRel)->title}}</p>
                                                    <p class="kt-font-dark kt-font-bold">{{ $model->postcode}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane table-responsive" id="kt_portlet_base_demo_1_2_tab_content" role="tabpanel">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php $collection = $model->driverBookingsRel; ?>
                                @if(!count($collection))
