...
class AppConfigController extends Controller {
    ...
    public function configurations() {
        ...
        return view('admin.configurations.pushnotifications.index', $data);
    }
    ...
    public function send_create() {
        return view('admin.configurations.pushnotifications.send');
    }
    ...
    public function send() {
        ...
        if( \request('user_type') == 'customer' ) {
            ...
            if ( \request('device_type') == 'ios' ) {
                ...
                sendIOSPushNotification( [request('device_token')], $data,  $key, true);
        ...
        sendPushNotification( [request('device_token')], $data,  $key, true);
    ...
    public function translation() {
        ...
        return view('admin.configurations.translation', compact('collection'));
    }
    ...
    public function translationStore() {
        ...
        if( request('title') ) {
            $model->tag = str_slug(\request('title'), '_'). '_'. $model->id;
        } else {
    ...
    public function translationRemove( $id ) {
        ...
        return redirect()->back()->withSuccess('Removed Successfully');
